...
if prediction == 'Jinnat':
    st.write('<span style="font-size:32px; color:red;">The evil spirit is a Jinnat</span>', unsafe_allow_html=True)
    jinnat_image = Image.open('jinnat.jpg')
    st.image(jinnat_image, caption='Jinnat')
    
elif prediction == 'Preta':
    st.write('<span style="font-size:32px; color:red;">The evil spirit is a Preta</span>', unsafe_allow_html=True)
    preta_image = Image.open('preta.jpg')
    st.image(preta_image, caption='Preta')
    
elif prediction == 'Bhoot':
    st.write('<span style="font-size:32px; color:red;">The evil spirit is a Bhoot</span>', unsafe_allow_html=True)
